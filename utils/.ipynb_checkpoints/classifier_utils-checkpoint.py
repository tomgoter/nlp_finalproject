...
from utils.data_utils import SEP_ID, CLS_ID
from utils.prepro_utils import encode_ids
...
def _truncate_seq_pair_keep_right(tokens_a, tokens_b, max_length):
  """Truncates a sequence pair in place to the maximum length. from bert code"""
