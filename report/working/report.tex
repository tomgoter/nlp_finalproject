...
\begin{table}
	...
	\caption{Classification Error Rates with UDA}\label{tab:baseline}
	\centering
		\begin{tabular}{R{1.8cm}p{1.0cm}p{0.6cm}p{0.6cm}p{1.0cm}p{0.7cm}}
			\toprule
			\multirow{2}{*}\textbf{Model} & \multicolumn{5}{c}{Training Set Size} \\
			\cline{2-6}
			& 20 & 200 & 2000 & 5000 & 12000 \\
			...
			\bottomrule
			\small
			\textbf{BERT UDA} & 0.776 & 0.676 & \textbf{0.335} & \textbf{0.291} & \textbf{0.205} \\
			\small
			\textbf{XLNet UDA} & 0.770 & 0.723 & \textbf{0.369} & \textbf{0.274} & \textbf{0.242} \\
			\midrule
			\small
			\textbf{ACE} & -0.006 & 0.047 & 0.034 & -0.017 & 0.037 \\
			\small
			\textbf{RCE} & -0.8\% & 6.5\% & 9.2\% & -3.0\% & 15.3\% \\
			\bottomrule
		\end{tabular}
		\begin{tablenotes}
			\small
